...
if ( ! class_exists( 'supermag_posts_col' ) ) {
    ...
    class supermag_posts_col extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supermag_cat_title' ) ); ?>"><?php _e( 'Title:', 'dupermag' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'supermag_cat' ) ); ?>"><?php _e('Select Category', 'dupermag'); ?></label>
                <?php
            ...
            <p>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'supermag_enable_first_featured' ) ); ?>"><?php _e( 'Enable First Post Featured' ,'dupermag'); ?></label>
                <br />
            </p>
